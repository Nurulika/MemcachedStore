// src/lib.rs
/*
 * Core library for MemcachedStore
 */
...
#[derive(Debug)]
pub struct MemcachedStoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MemcachedStoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MemcachedStore processing");
    
    let mut processor = MemcachedStoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MemcachedStoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MemcachedStoreProcessor::new(false);
